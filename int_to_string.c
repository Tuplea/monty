 ...
 *
 * @num: is number to convert to string
 *
 ...
 *
 * @i: is integer to get absolute value of
 * 
 ...
 *
 * @num: is number to get length needed for
 *
 * @base: is base of number representation used by buffer
 *
 * Return: integer containing length of buffer(doesn't contain null bt)
 */
int get_numbase_len(unsigned int num, unsigned int base)
{
 ...
 *
 * @buff: is buffer to fill with result of conversion
 *
 * @buff_size: is size of buffer in bytes
 *
 * Return: always void
 */
void fill_numbase_buff(unsigned int num, unsigned int base,
