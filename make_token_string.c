 ...
 *
 * @str: is string to seperate into words
 *
 * @delims: is delimitors to use to delimit words
 *
 * Return: is 2D array of pointers to each word
 */
 ...
 * @delims: is delimitors to use to delimit words
 *
 * Return: is length of current word
 */
...
/**
 * get_word_count - is gets the word count of a string
 *
 * @str: is string to get word count from
 *
 * @delims: is delimitors to use to delimit words
 *
...
/**
 * get_next_word - it gets the next word in a string
 *
